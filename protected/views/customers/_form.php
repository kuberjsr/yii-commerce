...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'customers_firstname',array('size'=>32,'maxlength'=>32)); ?>
		<?php echo $form->error($model,'customers_firstname'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'customers_lastname'); ?>
		<?php echo $form->textField($model,'customers_lastname',array('size'=>32,'maxlength'=>32)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'customers_email_address',array('size'=>60,'maxlength'=>96)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'customers_telephone',array('size'=>32,'maxlength'=>32)); ?>
		<?php echo $form->error($model,'customers_telephone'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'customers_fax'); ?>
		<?php echo $form->textField($model,'customers_fax',array('size'=>32,'maxlength'=>32)); ?>
