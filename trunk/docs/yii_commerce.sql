#
#  OsCommerce 2.2 sql creation script, the .xml doesn't seem to generate useful
#   SQL from MySQL Workbench but does create lovely diagrams :-)
#  Anyway, this version has demo data which is useful
#
