 ...
 */
class ProductsToCategories extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ProductsToCategories the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('products_id, categories_id', 'required'),
			array('products_id, categories_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('products_id, categories_id', 'safe', 'on'=>'search'),
		);
	}
